<nav class="bg-gray-800" x-data="{ isOpen: false }">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="/grades" :active="request()->is('grades')">Grade</x-nav-link>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <x-nav-link-mobile href="/grades" :active="request()->is('grades')">Grade</x-nav-link-mobile>
            <x-nav-link-mobile href="/departement" :active="request()->is('departement')">Departement</x-nav-link-mobile>
        </div>
